...
/**
 * Obtiene datos de la API OSM Overpass y devuelve el nodo más cercano a las coordenadas especificadas
...
/**
 * Obtiene datos del mapa y los convierte en una estructura gráfica.
 * @param {Array} boundingBox matriz con 2 objetos que tienen una propiedad de latitud y longitud 
 ...
 * @returns {Array} Matriz con 2 objetos que contienen propiedades de latitud y longitud
 */
